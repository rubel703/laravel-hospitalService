<aside class="sidebar-wrapper">
    ...
    <div class="textmenu">
        <div class="brand-logo">
            <img src="{{ asset('/') }}/backend-assets/images/brand-logo-2.png" width="140" alt="sorry" />
        </div>
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="pills-ecommerce">
                <div class="list-group list-group-flush">
                    ...
                    <a href="{{route('createdoctor')}}" class="list-group-item"><i 
                            class="bi bi-handbag"></i>Add New Doctor</a>
                    <a href="{{route('indexdoctor')}}" class="list-group-item"><i
                            class="bi bi-box-seam"></i>Managed Doctors</a>
                    <a href="{{route('create')}}" class="list-group-item"><i
                            class="bi bi-card-text"></i>Add Department</a>
                    <a href="{{route('index')}}" class="list-group-item"><i
                            class="bi bi-card-text"></i>Managed Department</a>
                    <a href="{{route('viewappoinment')}}" class="list-group-item"><i
                            class="bi bi-box-seam"></i>View Appoinment</a>
