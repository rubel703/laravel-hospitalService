      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-8">
                  ...
                  <img src="{{asset('/')}}/frontend-assets/images/about/sign.png" alt="" class="img-fluid">
              </div>
          </div>
      </div>
  </section>
          ...
          <div class="row">
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/about/about-1.jpg" alt="" class="img-fluid w-100">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/about/about-2.jpg" alt="" class="img-fluid w-100">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/about/about-3.jpg" alt="" class="img-fluid w-100">
              ...
              <div class="col-lg-3 col-md-6">
                  <div class="about-block-item">
                      <img src="{{asset('/')}}/frontend-assets/images/about/about-4.jpg" alt="" class="img-fluid w-100">
          ...
          <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/team/1.jpg" alt="" class="img-fluid w-100">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/team/2.jpg" alt="" class="img-fluid w-100">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/team/3.jpg" alt="" class="img-fluid w-100">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="team-block">
                      <img src="{{asset('/')}}/frontend-assets/images/team/4.jpg" alt="" class="img-fluid w-100">
