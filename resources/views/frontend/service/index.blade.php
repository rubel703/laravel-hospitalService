          ...
          <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="service-block mb-5">
                      <img src="{{asset('/')}}/frontend-assets/images/service/service-1.jpg" alt="" class="img-fluid">
                      <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="service-block mb-5">
                      <img src="{{asset('/')}}/frontend-assets/images/service/service-2.jpg" alt="" class="img-fluid">
                      <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="service-block mb-5">
                      <img src="{{asset('/')}}/frontend-assets/images/service/service-3.jpg" alt="" class="img-fluid">
                      <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="service-block mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/service/service-4.jpg" alt="" class="img-fluid">
                      <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="service-block mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/service/service-6.jpg" alt="" class="img-fluid">
                      <div class="content">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="service-block mb-5 mb-lg-0">
                      <img src="{{asset('/')}}/frontend-assets/images/service/service-8.jpg" alt="" class="img-fluid">
                      <div class="content">
